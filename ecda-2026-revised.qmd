...
![Source: authors’ analysis of out-of-fold predictions.](img/fig_reliability.svg){width=88% fig-align="center" fig-alt="Reliability plot showing that predicted probabilities understate the observed frequency of High and Unacceptable labels in the decision region."}

::: {.callout-warning .fragment}
For one High-risk bin, a predicted probability of 0.28 corresponds to an observed frequency of 0.72. The thresholds are therefore specific to this selected corpus.
:::
...
- severe examples are subsampled in the training sets
- every test set retains all positive cases
- four training sizes, with five random draws at each size

![Source: authors’ analysis. The dashed segment extrapolates beyond the observed sample sizes.](img/fig_learning_curve.svg){width=84% fig-align="center" fig-alt="Learning curve showing average precision increasing approximately linearly with the logarithm of the number of severe training examples."}

::: {.callout-important .fragment}
The curve quantifies the value of additional labels. Reaching AP 0.75 extrapolates to about **1,160 severe training examples**. This estimate guides the next collection phase and does not claim production readiness.
:::
...
- The log-linear fit has an R-squared of 0.979.
...
::: {.slides-link}
**Slides**  
[mchlbckr.github.io/ecda-2026-slides](https://mchlbckr.github.io/ecda-2026-slides/)
:::
...
![Source: authors’ analysis of out-of-fold predictions.](img/fig_reliability.svg){width=88% fig-align="center" fig-alt="Reliability plot for High and Unacceptable probabilities on out-of-fold predictions."}

::: {.callout-warning}
The aggregate expected calibration error is 0.005 because Minimal prompts dominate the corpus. In the decision region, predicted probabilities substantially understate observed frequencies. Aggregate calibration metrics can therefore hide the error that matters operationally.
:::
