...
- each point shows mean AP across five random subsamples
- vertical bars show one standard deviation across the five draws
- the solid line covers the observed range; the dashed line extrapolates beyond it

::: {.callout-important .fragment}
**Result.** Average precision continues to increase across the observed range. The fitted curve gains about 0.09 AP with each doubling of the severe training set.

AP 0.75 corresponds to about **1,160 severe examples**, but this estimate extrapolates beyond the largest observed training set of 400.
:::
