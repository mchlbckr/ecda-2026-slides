...
![Source: authors’ analysis of out-of-fold predictions.](img/fig_reliability.svg){width=78% fig-align="center" fig-alt="Reliability plot for High and Unacceptable prompts. Each point is one probability bin."}
...
- one 0.1-wide probability bin
- horizontal: mean predicted probability
- vertical: observed class frequency
- size: number of prompts on a logarithmic scale
